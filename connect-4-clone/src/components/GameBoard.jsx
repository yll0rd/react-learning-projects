...
import {GAME_STATE_PLAYING, GAME_STATE_WIN, NO_PLAYER, NUMBER_OF_CIRCLES, PLAYER_1, PLAYER_2} from "../Constants.js";
...
const GameBoard = () => {
    ...
    const circleClicked = (id) => {
        console.log(isWinner(gameBoard, id-1, currentPlayer))
