        ...
        <>
            ...
            <div className="d-flex justify-content-center align-items-center">
                ...
                <ul className="list-group mx-5">
                    <li className="list-group-item"><span className="fs-5 text-capitalize">name:</span> ---</li>
                    <li className="list-group-item"><span className="fs-5 text-capitalize">email:</span> --- </li>
